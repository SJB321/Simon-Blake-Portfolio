// Resume PDF — fixed visual style.
//
// Intentionally NOT theme-aware: the downloadable PDF stays in a stable,
// ATS-friendly design regardless of which web theme is active. Recruiters
// expect a consistent recognizable resume; theme changes belong on the
// portfolio site, not the document we send out.
...
// Fixed palette — these never change with the web theme.
const NAVY = '#1e3a5f'
const INK = '#1c1917'
const BODY = '#3f3a36'
const DIM = '#6b6660'
